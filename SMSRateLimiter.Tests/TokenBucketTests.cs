...
namespace SMSRateLimiter.Tests.Unit
{
    public class TokenBucketTests
    {
        ...
        {
            // Arrange & Act
            var bucket = new TokenBucket.TokenBucket(100, 10);
        ...
        {
            // Arrange
            var bucket = new TokenBucket.TokenBucket(10, 1);
        ...
        {
            // Arrange
            var bucket = new TokenBucket.TokenBucket(5, 1);
        ...
        {
            // Arrange
            var bucket = new TokenBucket.TokenBucket(10, 2); // 2 tokens per second
        ...
        {
            // Arrange
            var bucket = new TokenBucket.TokenBucket(5, 10); // 10 tokens per second, max 5
